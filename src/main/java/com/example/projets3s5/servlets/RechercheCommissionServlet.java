...
@WebServlet("/RechercheCommissionServlet")
public class RechercheCommissionServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try (Connection connection = ConnexionPost.getConnectionPost()) {
            if ("s".equals(mode)) {
                ...
                request.getRequestDispatcher("rechercheCommission.jsp").forward(request, response);
            }
        }catch (Exception e) {
            e.printStackTrace();
